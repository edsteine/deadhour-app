    ...
    return [
      {
        ...
        'description': 'Based on ${existingBookings.length} successful group bookings',
        'recommendations': ['14:00-16:00', '19:00-21:00'],
      },
      {
        'type': 'group_size',
        'title': 'Optimal Group Sizes',
        'description': 'Best group sizes for this venue (from ${existingBookings.length} bookings)',

...
class PerformanceOptimizationService {
  ...
  // Data cache with TTL
  final Map<String, _CachedData> _dataCache = {};
  ...
  void cacheVenueData(String venueId, Map<String, dynamic> data) {
    ...
    _dataCache[venueId] = _CachedData(data, DateTime.now().add(ttl));
  ...
  void _prefetchNextVenues(int currentIndex) {
    ...
    for (int i = 1; i <= prefetchCount; i++) {
      ...
      debugPrint('Prefetching venue at index: $nextIndex');
    }
  }
...
class _CachedData {
  ...
  _CachedData(this.data, this.expiryTime);

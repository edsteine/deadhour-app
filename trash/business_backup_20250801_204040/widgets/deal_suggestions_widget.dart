...
/// Smart suggestions section with AI-powered deal recommendations
class DealSuggestionsWidget extends StatelessWidget {
  final String businessType;
  final bool showSuggestions;
  final Function(bool) onToggleSuggestions;
  final Function(DealSuggestion) onApplySuggestion;

  const DealSuggestionsWidget({
    super.key,
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            TextButton.icon(
              onPressed: () => onToggleSuggestions(!showSuggestions),
              icon: Icon(

...
import 'ramadan_schedule.dart';
import 'cultural_holiday.dart';
...
class MoroccoCulturalService extends ChangeNotifier {
  ...
  Map<String, DateTime> getPrayerTimes({DateTime? date, String? city}) {
    ...
    return _prayerTimesCache[cacheKey] ??
        _generatePrayerTimes(targetDate, targetCity);
  }
  ...
  Future<void> _updatePrayerTimes() async {
    ...
    _todaysPrayerTimes = _generatePrayerTimes(today, _currentCity);
  ...
  Map<String, DateTime> _generatePrayerTimes(DateTime date, String city) {

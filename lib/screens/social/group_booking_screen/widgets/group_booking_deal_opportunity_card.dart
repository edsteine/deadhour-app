...
class GroupBookingDealOpportunityCard extends StatelessWidget {
  final Map<String, dynamic> opportunity;
  final VoidCallback onNegotiateDeal;

  const GroupBookingDealOpportunityCard({
    super.key,

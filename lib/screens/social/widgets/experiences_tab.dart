...
class ExperiencesTab extends StatelessWidget {
  ...
  final Function(Map<String, dynamic>) viewExperienceDetails;
  final Function(Map<String, dynamic>) contactHost;
  final Function(Map<String, dynamic>) joinExperience;

  const ExperiencesTab({
    super.key,
    required this.filteredExperiences,
    required this.socialInterests,
    required this.viewExperienceDetails,
    required this.contactHost,
    required this.joinExperience,
  });
  ...
  Widget _buildExperienceCard(Map<String, dynamic> experience) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => viewExperienceDetails(experience),
        borderRadius: BorderRadius.circular(8),
        child: Column(
                  ...
                  Row(
                    children: [
                      ...
                      Row(
                        children: [
                          OutlinedButton(
                            onPressed: () => contactHost(experience),
                            child: const Text('Message', style: TextStyle(fontSize: 12)),
                          ),
                          const SizedBox(width: 8),
                          ElevatedButton(
                            onPressed: () => joinExperience(experience),

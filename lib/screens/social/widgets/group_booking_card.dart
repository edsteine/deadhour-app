...
import 'group_booking_details_dialog.dart';

/// Card widget displaying a group booking with actions
class GroupBookingCard extends StatelessWidget {
  ...
  void _joinGroup(BuildContext context) {
    final result = groupBookingService.joinGroupBooking(booking['id'], 'user_current');
    onRefresh();
  ...
  void _leaveGroup(BuildContext context) {
    groupBookingService.leaveGroupBooking(booking['id'], 'user_current');
    onRefresh();
  ...
  void _showBookingDetails(BuildContext context) {
    GroupBookingDetailsDialog.show(context, booking);
  }

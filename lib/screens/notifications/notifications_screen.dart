...
import 'package:deadhour/services/notification_service.dart';
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildStatsHeader(stats, allNotifications, unreadCount),
          Expanded(
  ...
  Widget _buildStatsHeader(Map<String, dynamic> stats, List<dynamic> allNotifications, int unreadCount) {
    return Container(
        ...
        children: [
          Expanded(
            child: _buildStatItem(
              'Total',
              '${allNotifications.length} (${stats['total']})',
              Icons.notifications,
              Colors.blue,
            ),
          ),

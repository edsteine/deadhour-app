...
class CashbackService {
  ...
  CashbackCalculation calculateCashback(Deal deal, double bookingAmount) {
    ...
    final double baseRate = _categoryRates[venue.category] ?? _categoryRates['default']!;
    
    // Dead hour multiplier
    final double deadHourMultiplier = _getDeadHourMultiplier();
    
    // Tier bonus
    final double tierBonus = _getTierBonus();
    
    // Special deal bonus (higher cashback for higher discounts)
    final double dealBonus = _getDealBonus(deal);
    ...
    final double cashbackAmount = bookingAmount * finalRate;

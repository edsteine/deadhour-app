...
/// App features widget showing available features in grid layout
class ProfileAppFeaturesWidget extends StatelessWidget {
  const ProfileAppFeaturesWidget({super.key});

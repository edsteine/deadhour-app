...
This document provides a complete list of all screens, their functionalities, and corresponding routes within the DeadHour application, organized by feature module.

---

## Core Platform & User Management

**Module Description:** This section contains the essential shell of the application, including user onboarding, authentication, profile management, and settings.
...
## Business & Venue Module

**Module Description:** A self-contained module for the entire business and venue lifecycle. It includes public-facing discovery screens, as well as all the tools for a user with the `Business Role` to manage their venue, deals, bookings, and finances.

**Architectural Note:** A user with the `Business Role` is granted the ability to manage a `Venue` and its associated `Deals`. For a detailed explanation of this architectural decision, please see the `business_vs_venue_analysis.md` report.
...
- **Functionality:** Shows a list or map of all venues, with advanced filtering. This is a public-facing discovery screen.

### 15. Venue Detail Screen
- **Route:** `/venues/:venueId`
- **File:** `lib/screens/venues/venue_detail_screen.dart`
- **Functionality:** Shows detailed public information about a specific venue, including its deals, reviews, and cultural info.

### 9. Deals Screen
- **Route:** `/deals`
- **File:** `lib/screens/home/deals_screen.dart`
- **Functionality:** Displays a public list of all active deals, with filtering and sorting options.

### Management (Business Role Required)

### 20. Business Dashboard Screen
- **Route:** `/business`
- **File:** `lib/screens/business/business_dashboard_screen.dart`
- **Functionality:** The main dashboard for users with the Business Role to manage their venue, deals, and analytics.

### 21. Create/Edit Venue Profile Screen
- **Route:** `/business/venue/edit`
- **File:** `lib/screens/business/edit_venue_screen.dart`
- **Functionality:** A form for a Business Role user to create and manage their venue's profile.

### 22. Create Deal Screen
- **Route:** `/business/create-deal`
- **File:** `lib/screens/business/create_deal_screen.dart`
- **Functionality:** A form for a Business Role user to create new deals for their venue.

### 23. Deal Management Screen
- **Route:** `/business/deals`
- **File:** `lib/screens/business/deal_management_screen.dart`
- **Functionality:** Allows a Business Role user to view, edit, pause, or delete their active and past deals.
...
- **Functionality:** Provides tools and insights for Business Role users to optimize their revenue.

### 28. Analytics Dashboard Screen
- **Route:** `/business/analytics`
- **File:** `lib/screens/business/analytics_dashboard_screen.dart`
- **Functionality:** Provides detailed analytics on venue and deal performance for Business Role users.

### 29. Business Payouts & Earnings Screen
- **Route:** `/business/payouts`
- **File:** `lib/screens/business/business_payouts_screen.dart`
- **Functionality:** Allows Business Role users to view their earnings, manage payout methods, and see their transaction history.

---

## Consumer Experience Module

**Module Description:** Contains all screens related to the core consumer journey of finding and booking deals.
...
## Guide & Tourism Module

**Module Description:** A self-contained module for all guide, tourism, and local experience features.
...
**Module Description:** Contains all screens related to user-to-user interaction, community rooms, and social discovery.
...
**Module Description:** Contains all administrative screens and shared utilities that support the application.
